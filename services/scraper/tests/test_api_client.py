...
class TestAPIClientInit:
    ...
    @patch("src.api_client.settings")
    def test_init_custom_url(self, mock_settings):
        """Test custom API URL"""
        mock_settings.api_timeout = 30
...
class TestPreparePost:
    ...
    @patch("src.api_client.settings")
    def test_prepare_post_basic(self, mock_settings, sample_scored_post):
    ...
    @patch("src.api_client.settings")
    def test_prepare_post_missing_fields(self, mock_settings):
    ...
    @patch("src.api_client.settings")
    def test_prepare_post_converts_scores_to_int(self, mock_settings):
...
class TestPrepareUser:
    ...
    @patch("src.api_client.settings")
    def test_prepare_user_basic(self, mock_settings, sample_scored_user):
    ...
    @patch("src.api_client.settings")
    def test_prepare_user_maps_field_names(self, mock_settings):
    ...
    @patch("src.api_client.settings")
    def test_prepare_user_missing_fields(self, mock_settings):
...
class TestSendPosts:
    ...
    @patch("src.api_client.settings")
    @responses.activate
    def test_send_posts_success(self, mock_settings, sample_scored_post, mock_api_response):
    ...
    @patch("src.api_client.settings")
    @responses.activate
    def test_send_posts_empty_list(self, mock_settings):
    ...
    @patch("src.api_client.settings")
    @responses.activate
    def test_send_posts_api_error(self, mock_settings, sample_scored_post):
...
class TestSendUsers:
    ...
    @patch("src.api_client.settings")
    @responses.activate
    def test_send_users_success(self, mock_settings, sample_scored_user, mock_api_response):
    ...
    @patch("src.api_client.settings")
    @responses.activate
    def test_send_users_empty_list(self, mock_settings):
    ...
    @patch("src.api_client.settings")
    @responses.activate
    def test_send_users_validation_error(self, mock_settings, sample_scored_user):
...
class TestSendAll:
    ...
    def test_send_all_success(
        self, mock_settings, sample_scored_post, sample_scored_user, mock_api_response
    ):
    ...
    @patch("src.api_client.settings")
    @responses.activate
    def test_send_all_empty_lists(self, mock_settings):
